...
/*   Updated: 2022/10/24 18:19:52 by sguilher         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "unit_tests.h"

void	transform_color_test(char *str, t_color expected, int s)
{
	int			status;
	t_color		color;
	static int	n = 1;
	...
	if (color.color == expected.color && status == s)
		printf(GREEN "OK" END "\n");
	else
		printf(RED "KO" END "\n");
	n++;
...
void	transform_input_tests(void)
{
	...
	transform_color_test("255,255,255", (t_color)0xFFFFFF, OK);
	transform_color_test("0,0,0", (t_color)0x000000, OK);
	transform_color_test("2555,255,255", (t_color)0x000000, ERROR);
	transform_color_test("255,260,255", (t_color)0xFF04FF, ERROR);
